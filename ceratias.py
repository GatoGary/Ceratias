...
class CuentaDialog(QDialog):
    ...
    def init_ui(self):
        ...
        fila_dato("📧", "Correo electrónico",   self.user_data.get("email", "—"))
...
class AcercaDeDialog(QDialog):
    ...
    def init_ui(self):
        ...
        texto_desc = (
            ...
            "relacionados con tallas, ofreciendo al usuario una experiencia más ágil "
            "y eficiente. Actualmente dispone de dos modos de cálculo rápido: "
            "Manual y Automático.\n\n"
            "El modo Automático se encuentra en fase de desarrollo (beta). Nuestro "
        ...
        lbl_funciones_titulo = QLabel("📋 Funciones principales")
        ...
        texto_funciones = (
            "• <b>Cálculo Manual:</b> Ingresa manualmente los valores de talla e impresión para obtener precios ajustados.\n\n"
            "• <b>Cálculo Automático:</b> Sube archivos de tu perfil de precios y la app procesará automáticamente los datos (beta).\n\n"
            "• <b>Gestión de perfiles:</b> Crea, edita y guarda múltiples perfiles de precios para diferentes escenarios.\n\n"
            "• <b>Exportación:</b> Descarga tus resultados en diferentes formatos para usar en otros sistemas.\n\n"
            "• <b>Historial:</b> Accede a tus cálculos anteriores y reutiliza configuraciones previas."
        )
        ...
        lbl_instrucciones_titulo = QLabel("🎯 Cómo empezar")
        ...
        texto_instrucciones = (
            ...
            "2. <b>Configura tus parámetros:</b> Ingresa o importa los datos de talla, tinta y precios.\n\n"
            "3. <b>Obtén resultados:</b> La app calculará automáticamente los precios ajustados.\n\n"
            "4. <b>Exporta o guarda:</b> Descarga tus resultados o guarda tu configuración para luego."
        )
        ...
        texto_monitoreo_desc = (
            ...
            "para optimizar el cálculo de precios."
        )
        ...
        texto_uso = (
            ...
            "4. <b>Obtén cálculos precisos:</b> Los datos recopilados se usan para generar precios más exactos."
        )
...
class MainWindow(QMainWindow):
    ...
    def _actualizar_titulo_perfil(self):
        self.setWindowTitle(f"CERATIAS  —  Perfil: {gestor.perfil_activo}")
    ...
    def _asi_toast(self, titulo, mensaje):
        ...
        try:
            ...
            toast = Notification(app_id="Asistente", title=titulo, msg=mensaje,
